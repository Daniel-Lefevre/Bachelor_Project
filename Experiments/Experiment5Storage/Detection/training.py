...
if os.path.exists(yaml_path):
    ...
    data_config["path"] = os.path.join(base_path)
...
results = model.train(
    ...
    project=os.path.join(base_path, "final_results_single"),
...
final_model_path = os.path.join(base_path, "final_results_single/Robot_Object_Finder_Final/weights/best.pt")
