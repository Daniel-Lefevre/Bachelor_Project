...
class_map = {"Unknown": 0, "Green_Circle": 1, "Green_Square": 2, "Blue_Circle": 3, "Blue_Square": 4, "Red_Circle": 5, "Red_Square": 6}


def convert_csv_to_yolo(csv_file, output_folder="yolo_labels_fresh"):
    ...
    for image_name, group in df.groupby("image_name"):
        ...
        for _, row in group.iterrows():
            label = str(row["label_name"]).replace(" ", "_")
...
target_file = os.path.join(script_dir, "labels_my-project-name_2026-03-20-02-42-24.csv")
